export default function StatCard({ label, value, sub, variant = "default", icon, chart }) {
  if (variant === "gold") {
    return (
      <div className="group relative overflow-hidden rounded-2xl border-none bg-gradient-to-br from-[#3A2B18] via-[#5C4320] to-gold-deep p-5 text-on-gold shadow-[0_18px_36px_-18px_rgba(42,31,20,0.55)] transition duration-300 hover:shadow-[0_22px_44px_-16px_rgba(42,31,20,0.6)] sm:p-6">
