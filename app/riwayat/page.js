    ...
    <div className="min-h-screen bg-cream pb-16">
      ...
      <main className="mx-auto max-w-2xl px-4 py-8 sm:px-6">
        ...
        <div className="mt-6 flex flex-col gap-4">
          {monthKeys.length === 0 ? (
            <div className="rounded-2xl border border-line bg-white p-8 text-center text-sm text-ink-2">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-xl border-[1.5px] border-gold bg-white py-3 text-sm font-semibold text-gold-deep transition hover:bg-cream-2"
          >
